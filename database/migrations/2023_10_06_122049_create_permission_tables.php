...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->foreignIdFor(DatabaseRoute::class)->nullable();
            $table->softDeletes();
            $table->timestamps();
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            ...
            $table->string('name');       // For MySQL 8.0 use string('name', 125);
            $table->string('description', 350)->nullable();       // For MySQL 8.0 use string('name', 125);
            $table->string('range', 500)->nullable();       // For MySQL 8.0 use string('name', 125);
            $table->string('used_for')->default('backend')->comment('backend, frontend'); // For MySQL 8.0 use string('guard_name', 125);
            $table->string('guard_name'); // For MySQL 8.0 use string('guard_name', 125);
            $table->softDeletes();
            $table->timestamps();
