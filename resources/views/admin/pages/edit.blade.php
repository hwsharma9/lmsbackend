        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('manage.pages.update', ['page' => $page->id])}}" id="frmPrivilege">
                        @method('PATCH')
                        @csrf
                        @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="slug" value="{{old('slug', $page->slug)}}" id="slug" class="form-control" style="width: 100%;" readonly />
                                        @error('slug')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="title_hi" value="{{old('title_hi', $page->title_hi)}}" id="title_hi" class="form-control" style="width: 100%;" />                                            
                                        @error('title_hi')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="title_en" value="{{old('title_en', $page->title_en)}}" id="title_en" class="form-control" style="width: 100%;" />
                                        @error('title_en')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_title" value="{{old('meta_title', $page->meta_title)}}" class="form-control" id="meta_title" placeholder="Enter Meta Title" style="width: 100%;" />
                                        @error('meta_title')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keyword" value="{{old('meta_keyword', $page->meta_keyword)}}" id="meta_keyword" class="form-control" style="width: 100%;" />
                                        @error('meta_keyword')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
