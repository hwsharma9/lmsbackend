        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('Database Routes') }}</li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">View</a></li>
                </ol>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <div class="float-sm-right">
                    @if (Gate::allows('check-auth', 'manage.databaseroutes.create'))
                        <a href="{{route('manage.databaseroutes.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
                    @endif
                </div>
            </div><!-- /.col -->
        </div><!-- /.row -->
